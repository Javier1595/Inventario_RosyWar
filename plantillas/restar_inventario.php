		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<div class="col-sm-10 col-md-10 col-lg-10">
						<form action="/Inventario_RosyWar/Index.php/resto_inventario" method="post" name="formRestarVenta" class="form-horizontal">
				            ...
				            <div class="form-group">
								...
								<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
				                	<center><a class="btn btn-primary" href="javascript:enviar_formRestarVenta()"><span class="glyphicon glyphicon-remove"></span> Restar</a></center>
								</div>
			            	</div>
						</form>
				</div>
