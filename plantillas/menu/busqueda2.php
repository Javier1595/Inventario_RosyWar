...
<div class="panel-body">
	<form action="/Inventario_RosyWar/Index.php/ingreso_busqueda_en_inventario" method="post" name="formBuscarEnInventario" class="form-inline" role="form">
...
<?php include "plantillas/ingresar_inventario.php"; ?>